...
--
-- Host: localhost:3306
-- Generation Time: May 15, 2016 at 12:09 AM
...
(1, 'ExampleLoopingItem', '2016-05-14 20:00:33', '2016-03-17 14:22:43', 'John', 'Smith', 2, 16, 8),
(2, 'ExampleLoopingItem', '2016-05-14 20:00:16', '2016-03-17 14:23:44', 'Jane', 'Smith', 1, 18, 8),
(3, 'ExampleLoopingItem', '2016-05-14 20:01:18', '2016-03-17 19:28:43', 'George', 'Washington', 1, 19, 14),
(4, 'ExampleLoopingItem', '2016-05-14 20:01:32', '2016-03-17 19:29:01', 'Abraham', 'Lincoln', 2, 16, 14),
(5, 'ExampleLoopingItem', '2016-05-14 20:01:46', '2016-03-18 19:43:16', 'Mr.', 'Fluffy', 3, 18, 14);
...
(11, 'Folder', '2016-05-14 19:57:32', '2016-05-14 19:57:32', 'Uploads', 'Uploads', 'assets/Uploads/', NULL, 1, 0, 3),
(15, 'Image', '2016-05-14 19:59:50', '2016-05-14 19:59:50', 'SilverStripeLogo.png', 'SilverStripeLogo.png', 'assets/Uploads/SilverStripeLogo.png', NULL, 1, 11, 3),
(16, 'Image', '2016-05-14 19:59:50', '2016-05-14 19:59:50', 'abel.jpeg', 'abel.jpeg', 'assets/Uploads/abel.jpeg', NULL, 1, 11, 3),
(17, 'Image', '2016-05-14 19:59:50', '2016-05-14 19:59:50', 'bird.jpg', 'bird.jpg', 'assets/Uploads/bird.jpg', NULL, 1, 11, 3),
(18, 'Image', '2016-05-14 19:59:50', '2016-05-14 19:59:50', 'cat.jpg', 'cat.jpg', 'assets/Uploads/cat.jpg', NULL, 1, 11, 3),
(19, 'Image', '2016-05-14 19:59:50', '2016-05-14 19:59:50', 'georgew.jpg', 'georgew.jpg', 'assets/Uploads/georgew.jpg', NULL, 1, 11, 3);
...
(3, 'Member', '2016-05-14 00:10:18', '2016-05-14 00:10:18', 'Default Admin', NULL, 'admin', '781133b83916fbfd8e902896ddbc02d1b7d85c75', '2016-05-17 00:10:18', NULL, NULL, 1, '2016-05-14 20:08:44', NULL, NULL, NULL, NULL, NULL, NULL, 'en_US', 0, NULL, NULL);
...
(189, 16, 8, 1, 3, 3, 'DP_Image_SetWidthPage', '2016-05-14 20:02:12', '2016-03-16 18:30:17', '08-image-setwidth', '08_image_setwidth', NULL, '<p>SilverStripe''s base classes have quite a few utility functions baked in. Image''s have the ability to generate a resampled version with max dimensions determined per the view''s implementation.</p><p>Below we have a 3.5 MB image. It''s maximum possible width is really only 815 px. This means that a lot of extra space is being wasted because it is being scaled down. If we use Image.setWidth(815), then a resampled version of the image is generated saving the user a tremendous amount of request data while having no impact on the quality of the image.</p><p>The resampled image is automatically updated if the source image is ever changed. This allows the CMS Admin to only need to manage the high resolution versions of the image as the view will automatically optimize them.</p>', NULL, NULL, 1, 1, 10, 0, 0, NULL, 'Inherit', 'Inherit', 6),
(190, 16, 9, 1, 3, 3, 'DP_Image_SetWidthPage', '2016-05-14 20:08:18', '2016-03-16 18:30:17', '08-image-setwidth', '08_image_setwidth', NULL, '<p>SilverStripe''s base classes have quite a few utility functions baked in. Image''s have the ability to generate a resampled version with max dimensions determined per the view''s implementation.</p><p>Below we have a 3.5 MB image. It''s maximum possible width is really only 815 px. This means that a lot of extra space is being wasted because it is being scaled down. If we use Image.setWidth(815), then a resampled version of the image is generated saving the user a tremendous amount of request data while having no impact on the quality of the image.</p><p>The resampled image is automatically updated if the source image is ever changed. This allows the CMS Admin to only need to manage the high resolution versions of the image as the view will automatically optimize them.</p>', NULL, NULL, 1, 1, 10, 0, 0, NULL, 'Inherit', 'Inherit', 6);
